...
# ───────── АВТО-СТАВКА ───────────────────────────────────────
# ЭТАП 1 (17.07): включён сам модуль авто-ставки, НО в auto_bet_7777.py
# по-прежнему AUTO_BET_DRY_RUN = True — т.е. на каждом сигнале бот
# реально находит матч/кнопку/коэф. и пишет в Telegram, что он БЫ
# поставил, но НЕ кликает. Это безопасный тест полного цикла на живых
# сигналах без риска деньгами. Реальные ставки включаются ОТДЕЛЬНО —
# только флагом AUTO_BET_DRY_RUN = False в auto_bet_7777.py, после
# того как холостые прогоны покажут корректные матч/кнопку/коэф.
